...
<head>
    <meta charset="UTF-8">
    <title>Editando Videojuego</title>
      ...
      <form method="post" name="crearVideojuego" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="less">
                <input 
                  ...
                  value="<?php echo $fecha_lanzamiento; ?>"
                >
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <!-- Boton para enviar los datos a la base de datos -->
              <a onclick="return confirm('Esta seguro de Editar el videojuego')">
                <button type="submit" 
                value="Registrar Videojuego" 
                name ="send" 
                class="btn btn-info">Editar Videojuego </button>
              </a>
            </div>
        </div>
      </form>
